...
[Download OctoPrompt's Latest Prebuilt Bun Server and UI Bundle](https://github.com/brandon-schabel/octoprompt/releases/download/v0.7.2/octoprompt-0.7.2-bun-bundle.zip)

[Download OctoPrompt For MacOS arm64 Binary - M1 and Newer](https://github.com/brandon-schabel/octoprompt/releases/download/v0.7.2/octoprompt-0.7.2-macos-arm64.zip)

[Download OctoPrompt For Windows x64 Binary](https://github.com/brandon-schabel/octoprompt/releases/download/v0.7.2/octoprompt-0.7.2-windows-x64.zip)

[Download OctoPrompt For Linux x64 Binary](https://github.com/brandon-schabel/octoprompt/releases/download/v0.7.2/octoprompt-0.7.2-linux-x64.zip)
...
```bash
cd octoprompt-0.7.2-bun-bundle && bun run start
```
...
```bash
cd ~/Downloads/octoprompt-v0.7.2
```
...
After downloading and extracting the appropriate zip file (e.g., `octoprompt-v0.7.2-windows-x64.zip`), open Command Prompt or PowerShell.

Navigate to the extracted folder. For example, if you extracted it to your Downloads folder:

```batch
cd %USERPROFILE%\Downloads\octoprompt-v0.7.2-windows-x64
```

Or using PowerShell:

```powershell
cd $env:USERPROFILE\Downloads\octoprompt-v0.7.2-windows-x64
```
...
```bash
cd dist/octoprompt-0.7.2-macos
```
