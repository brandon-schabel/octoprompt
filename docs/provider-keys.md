...
- **Security:** Treat your API keys like passwords. Do not share them publicly or commit them to version control (e.g., in a public GitHub repository). Promptliano stores them locally on your machine.
