...
- **Services Layer (`@octprompt/services`)**: Business logic orchestrating storage.
...
- For many versioned routes, consider sub-routers: `app.route('/v1', v1Router)`.g by incrementing until unique.
