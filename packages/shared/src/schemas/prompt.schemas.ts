...
export const PromptSchema = z
  .object({
    ...
    projectId: z
      ...
      .min(1)
      .optional()
      .openapi({ example: 'project-123', description: 'Optional Project ID this prompt is linked to (contextual)' }),
    createdAt: z
      .string()
      .datetime()
      .openapi({ example: '2024-02-01T10:00:00.000Z', description: 'Creation timestamp (ISO 8601)' }),
    updatedAt: z
      .string()
      .datetime()
      .openapi({ example: '2024-02-01T10:05:00.000Z', description: 'Last update timestamp (ISO 8601)' })
  })
  .openapi('Prompt')
...
export const CreatePromptBodySchema = z
  .object({
    ...
    projectId: z
      ...
      .min(1)
      .optional()
      .openapi({ example: 'project-456', description: 'Optional Project ID to link the prompt to upon creation' }),
