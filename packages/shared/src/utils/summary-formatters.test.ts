  ...
  describe('buildProjectSummaryWithFormat', () => {
    const testFiles: ProjectFile[] = [
      createTestFile({
        ...
        imports: [
          { source: './utils', specifiers: [{ type: 'named', local: 'helper', imported: 'helper' }] }
        ],
        exports: [
      ...
      createTestFile({
        ...
        exports: [
          { type: 'named', source: null, specifiers: [{ type: 'named', local: 'helper', exported: 'helper' }] }
        ]
      }),
      createTestFile({
        id: 3,
