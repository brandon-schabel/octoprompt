...
describe('File Summarization with Local Models', () => {
  ...
  describe('Single File Summarization', () => {
    test(
      'should summarize a simple TypeScript file',
      async () => {
    ...
    test(
      'should handle large files with truncation',
      async () => {
  ...
  describe('Batch File Summarization', () => {
    test(
      'should summarize multiple files efficiently',
      async () => {
    ...
    test(
      'should handle mixed file types in batch',
      async () => {
        const files = [typescriptFiles.simpleClass, pythonFiles.dataProcessor, edgeCaseProjectFiles.emptyFile]
    ...
    test(
      'should respect force flag for resummarization',
      async () => {
        ...
        const secondResult = await summarizeFiles(testProject.id, [file.id], false)
  ...
  describe('Summary Caching', () => {
    test(
      'should use cache for repeated summarizations',
      async () => {
...
export { LOCAL_MODEL_TEST_CONFIG, isLMStudioAvailable, requireLMStudio }
