...
export namespace E {
  ...
  export const isLeft = <E, A>(e: Either<E, A>): e is EffectEither.Left<E, never> => 
    EffectEither.isLeft(e)
  
  export const isRight = <E, A>(e: Either<E, A>): e is EffectEither.Right<never, A> => 
    EffectEither.isRight(e)
  ...
  export const map = <A, B>(f: (a: A) => B) => <E>(e: Either<E, A>): Either<E, B> =>
    EffectEither.map(e, f)
  
  export const chain = <E, A, B>(f: (a: A) => Either<E, B>) => (e: Either<E, A>): Either<E, B> =>
    EffectEither.flatMap(e, f)
  
  export const fromNullable = <E>(onNullable: E) => <A>(a: A | null | undefined): Either<E, A> =>
...
export namespace TE {
  ...
  export const fromEither = <E, A>(e: E.Either<E, A>): TaskEither<E, A> =>
    () => Promise.resolve(e)
...
export namespace O {
  ...
  export const isNone = <A>(o: Option<A>): o is null | undefined =>
    o == null
  
  export const isSome = <A>(o: Option<A>): o is A =>
    o != null
  ...
  export const chain = <A, B>(f: (a: A) => Option<B>) => (o: Option<A>): Option<B> =>
    isSome(o) ? f(o) : none
...
export namespace R {
  ...
  export const of = <R, A>(a: A): Reader<R, A> => () => a
  
  export const ask = <R>(): Reader<R, R> => r => r
  
  export const map = <A, B>(f: (a: A) => B) => <R>(ra: Reader<R, A>): Reader<R, B> =>
    r => f(ra(r))
  
  export const chain = <R, A, B>(f: (a: A) => Reader<R, B>) => (ra: Reader<R, A>): Reader<R, B> =>
    r => f(ra(r))(r)
}
...
export namespace RTE {
  ...
  export const fromTaskEither = <E, A, R = unknown>(te: TE.TaskEither<E, A>): ReaderTaskEither<R, E, A> =>
    () => te
  
  export const chain = <R, E, A, B>(
    f: (a: A) => ReaderTaskEither<R, E, B>
  ) => (rte: ReaderTaskEither<R, E, A>): ReaderTaskEither<R, E, B> =>
    r => TE.chain((a: A) => f(a)(r))(rte(r))
}