...
describe.skipIf(skipIfNoLMStudio)('LMStudio Integration Tests', () => {
  ...
  describe('SCoT Optimizer with LMStudio', () => {
    ...
    test('should handle complex algorithmic prompts', async () => {
      if (!provider) return
  ...
  describe('Self-Consistency Optimizer with LMStudio', () => {
    test('should generate multiple consistent solutions', async () => {
      if (!provider) return
    ...
    }, TEST_TIMEOUTS.integration * 3) // Multiple samples take longer
  ...
  describe('PromptEngineer with LMStudio', () => {
    test('should work with all optimizers', async () => {
      if (!provider) return
  ...
  describe('Real-world Scenarios', () => {
    test('should optimize code generation prompt', async () => {
      if (!provider) return
    ...
    test('should optimize data processing prompt', async () => {
      if (!provider) return
  ...
  describe('Performance Benchmarks', () => {
    test('should measure optimization improvement', async () => {
      if (!provider) return
      ...
      const optimizedSolution = await provider.generate(
        optimizedResult.userPrompt,
        0.7,
        0.9
      )
  ...
  describe('Error Handling', () => {
    test('should handle network errors gracefully', async () => {
      ...
      await expect(
        badProvider.generate('Test prompt', 0.7, 0.9)
      ).rejects.toThrow()
    })
    ...
    test('should handle timeout', async () => {
      ...
      await expect(
        timeoutProvider.generate(TEST_PROMPTS.complex.systemDesign, 0.7, 0.9)
