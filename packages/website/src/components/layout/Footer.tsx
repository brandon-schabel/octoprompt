...
import { FooterNavigation } from '@/schemas/navigation.schemas'
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'blog', label: 'Blog', href: '/blog', target: '_blank' },
        { id: 'careers', label: 'Careers', href: '/careers', target: '_blank' },
        { id: 'contact', label: 'Contact', href: '/contact' }
      ]
    }
  ],
  copyright: `© ${new Date().getFullYear()} Promptliano. All rights reserved.`,
  socialLinks: [
    {
      platform: 'github',
    ...
    {
      platform: 'discord',
      url: 'https://discord.gg/promptliano',
      label: 'Discord'
    },
    {
      platform: 'twitter',
      ...
      <div className='container mx-auto px-4 py-12'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8 mb-8'>
          <div className='col-span-2 md:col-span-1'>
            <h3 className='text-lg font-semibold mb-4'>Promptliano</h3>
            <p className='text-sm text-muted-foreground'>
              AI-powered development assistant with seamless MCP integration.
            </p>
          </div>
        ...
        <div className='border-t pt-8 flex flex-col md:flex-row justify-between items-center'>
          <p className='text-sm text-muted-foreground mb-4 md:mb-0'>{footerNavigation.copyright}</p>
