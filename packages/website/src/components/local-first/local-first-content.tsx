    ...
    <div className='py-20 px-4 md:px-6 lg:px-8'>
      ...
      >
        ...
        <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
          Promptliano runs entirely on your computer. No cloud dependencies, no data collection, 
          no external servers. Just powerful development tools that respect your privacy.
        </p>
      </motion.div>
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          ...
          >
            <GlassCard className='p-6 h-full'>
              ...
              <p className='text-muted-foreground'>
                All your project data, tickets, and configurations are stored in a local SQLite database 
                on your machine. No cloud sync required.
              </p>
            </GlassCard>
          </motion.div>
          ...
          >
            <GlassCard className='p-6 h-full'>
              ...
              <p className='text-muted-foreground'>
                Your API keys and sensitive data are encrypted using industry-standard encryption 
          ...
          >
            <GlassCard className='p-6 h-full'>
              ...
              <p className='text-muted-foreground'>
                No analytics, no telemetry, no usage tracking. What you do with Promptliano 
          ...
          <GlassCard className='p-8 bg-green-500/5 border-green-500/20'>
            <div className='text-center mb-8'>
              ...
              <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
                Promptliano is and will always be free and open source software. 
                We believe in transparency, community collaboration, and user freedom.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-3 gap-6 mt-8'>
              ...
              <div className='text-center'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Built by developers, for developers. Contributions, feedback, and ideas from the community shape our roadmap.
                </p>
              </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground mb-4'>
                    When you first launch Promptliano, it automatically creates a SQLite database in your 
                    application data directory. This database stores:
                  </p>
                  <ul className='space-y-2 text-muted-foreground'>
            ...
            <GlassCard className='p-8'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground mb-4'>
                    Direct integration with your local Git repositories:
                  </p>
                  <ul className='space-y-2 text-muted-foreground'>
                    <li className='flex items-center gap-2'>
                      <CheckCircle className='h-5 w-5 text-green-500 flex-shrink-0' />
            ...
            <div className='flex items-start gap-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground mb-6'>
                  For complete privacy, Promptliano supports local AI providers. Your code never leaves 
                  your machine, even when using AI features:
                </p>
      ...
      >
        <GlassCard className='p-12'>
          ...
          <p className='text-xl text-muted-foreground mb-8'>
            Experience the power of local-first development. No cloud lock-in, no privacy concerns, 
