  ...
  loader: () => {
    return {
      meta: {
        ...
        description: 'Download and install Promptliano on your platform. Get started in minutes with our prebuilt binaries.',
          ...
          <div className='flex items-start gap-3'>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                Bun runtime installed. If you don't have it:
              </p>
              <div className='mt-2 space-y-2'>
                <CodeBlock code='# Install with npm
npm install -g bun
...
powershell -c "irm bun.sh/install.ps1 | iex"' language='bash' />
              </div>
            </div>
          </div>
          <div className='flex items-start gap-3'>
            ...
            <GlassCard className='p-6'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <CodeBlock code='# Download the bundle
curl -L https://github.com/brandon-schabel/promptliano/releases/download/v0.8.0/promptliano-0.8.0-bun-bundle.zip -o promptliano.zip

# Extract the zip file
unzip promptliano.zip

# Navigate to the extracted folder
cd promptliano-0.8.0-bun-bundle' language='bash' />
                </div>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Navigate to <a href='http://localhost:3579' className='text-primary underline'>http://localhost:3579</a>
                  </p>
                </div>
              </div>
            </GlassCard>
          ...
          <TabsContent value='macos' className='space-y-4'>
            <GlassCard className='p-6'>
                ...
                <div className='flex items-start gap-2'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground mt-1'>
                      macOS will quarantine the binary since it's not code-signed. You'll need to remove the quarantine flag.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='space-y-4'>
                <div>
                  <h4 className='font-medium mb-2'>1. Download and extract</h4>
                  <CodeBlock code='# Download for Apple Silicon (M1 and newer)
curl -L https://github.com/brandon-schabel/promptliano/releases/download/v0.8.0/promptliano-0.8.0-macos-arm64.zip -o promptliano.zip

# Extract the zip file
unzip promptliano.zip

# Navigate to the extracted folder
cd promptliano-0.8.0-macos-arm64' language='bash' />
                </div>
                ...
                <div>
                  ...
                  <CodeBlock code='# Make the binary executable
chmod +x ./promptliano

# Run Promptliano
./promptliano' language='bash' />
                </div>
            ...
            <GlassCard className='p-6'>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <CodeBlock code='# Using PowerShell
Invoke-WebRequest -Uri "https://github.com/brandon-schabel/promptliano/releases/download/v0.8.0/promptliano-0.8.0-windows-x64.zip" -OutFile "promptliano.zip"

# Extract the zip file
Expand-Archive -Path "promptliano.zip" -DestinationPath "."

# Navigate to the extracted folder
cd promptliano-0.8.0-windows-x64' language='powershell' />
                </div>

                <div>
                  <h4 className='font-medium mb-2'>2. Run Promptliano</h4>
                  <CodeBlock code='# Run the executable
.\promptliano.exe

# Or simply double-click promptliano.exe in File Explorer' language='batch' />
                </div>

                <div className='bg-blue-500/10 border border-blue-500/20 rounded-lg p-4'>
                  <p className='text-sm'>
                    <span className='font-medium'>Windows Defender Note:</span> You may need to click "More info" and then "Run anyway" if Windows Defender SmartScreen appears.
                  </p>
                </div>
          ...
          <TabsContent value='linux' className='space-y-4'>
            <GlassCard className='p-6'>
              ...
              <div className='space-y-4'>
                <div>
                  <h4 className='font-medium mb-2'>1. Download and extract</h4>
                  <CodeBlock code='# Download the Linux binary
wget https://github.com/brandon-schabel/promptliano/releases/download/v0.8.0/promptliano-0.8.0-linux-x64.zip

# Extract the zip file
unzip promptliano-0.8.0-linux-x64.zip

# Navigate to the extracted folder
cd promptliano-0.8.0-linux-x64' language='bash' />
                </div>
...
./promptliano' language='bash' />
                ...
                <div className='bg-green-500/10 border border-green-500/20 rounded-lg p-4'>
                  <p className='text-sm'>
                    <span className='font-medium'>Tip:</span> You can add Promptliano to your PATH for easier access from anywhere.
                  </p>
                </div>
              </div>
            </GlassCard>
          ...
          <div className='space-y-4'>
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  You should see output like: <code className='px-1.5 py-0.5 bg-muted rounded text-xs'>Server running at http://localhost:3579</code>
                </p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  Open your browser and navigate to <a href='http://localhost:3579' className='text-primary underline'>http://localhost:3579</a>
                </p>
              </div>
            </div>
      ...
      <GlassCard className='p-8 bg-primary/5 border-primary/20'>
        ...
        <p className='mb-4 text-muted-foreground'>
          Now that you have Promptliano running, here's what to do next:
        </p>
