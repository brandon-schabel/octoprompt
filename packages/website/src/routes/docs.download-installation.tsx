...
curl -L https://github.com/brandon-schabel/promptliano/releases/download/v0.9.0/promptliano-0.9.0-bun-bundle.zip -o promptliano.zip

# Extract the zip file
unzip promptliano.zip

# Navigate to the extracted folder
cd promptliano-0.9.0-bun-bundle'
                    language='bash'
                  />
                </div>
...
curl -L https://github.com/brandon-schabel/promptliano/releases/download/v0.9.0/promptliano-0.9.0-macos-arm64.zip -o promptliano.zip

# Extract the zip file
unzip promptliano.zip

# Navigate to the extracted folder
cd promptliano-0.9.0-macos-arm64'
                    language='bash'
                  />
                </div>
...
Invoke-WebRequest -Uri "https://github.com/brandon-schabel/promptliano/releases/download/v0.9.0/promptliano-0.9.0-windows-x64.zip" -OutFile "promptliano.zip"

# Extract the zip file
Expand-Archive -Path "promptliano.zip" -DestinationPath "."

# Navigate to the extracted folder
cd promptliano-0.9.0-windows-x64'
                    language='powershell'
                  />
                </div>
...
wget https://github.com/brandon-schabel/promptliano/releases/download/v0.9.0/promptliano-0.9.0-linux-x64.zip

# Extract the zip file
unzip promptliano-0.9.0-linux-x64.zip

# Navigate to the extracted folder
cd promptliano-0.9.0-linux-x64'
                    language='bash'
                  />
                </div>
