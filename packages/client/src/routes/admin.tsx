                      ...
                      <TableBody>
                        {Object.entries(envInfo.environment).map(([key, value]) => (
                          <TableRow key={key}>
                            ...
                            <TableCell>{value || <span className="text-muted-foreground italic">undefined</span>}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          <Badge 
                            variant={systemStatus.checks.api === 'healthy' ? 'default' : 'destructive'}
                          >
