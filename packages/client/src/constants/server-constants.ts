...
export const SERVER_HTTP_ENDPOINT =
  process.env.NODE_ENV === 'development' ? `http://${SERVER_HOSTNAME}:${SERVER_PORT_DEV}` : ''
export const SERVER_WS_ENDPOINT =
  process.env.NODE_ENV === 'development'
    ? `ws://${SERVER_HOSTNAME}:${SERVER_PORT_DEV}/ws`
    : `ws://${SERVER_HOSTNAME}:${SERVER_PORT_PROD}/ws`
