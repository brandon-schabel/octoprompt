...
export function ChatSidebar({
    ...
    const { currentChat, setCurrentChat } = chatControl
                            ...
                            <CommandList>
                                <CommandEmpty>
                                    {isLoadingModels ? (
                                        ...
                                        "No models available. The provider may be offline."
                                    )}
                                </CommandEmpty>
            ...
            <ScrollArea className="flex-1">
                {isLoadingChats ? (
                    ...
                    chats.map((chat) => (
                        <div
                            key={chat.id}
                            className="flex items-center justify-between p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md group"
                        >
                            {editingChatId === chat.id ? (
                                ...
                                <>
                                    <button
                                        className={`w-[120px] text-left truncate ${currentChat?.id === chat.id ? 'font-bold' : ''}`}
