...
export function SlidingSidebar({ children, width = 300, side = 'left', isOpen, onClose }: SlidingSidebarProps) {
  ...
  return (
    <>
      <div
        ...
        aria-hidden={!isOpen}
      >
        <div className='flex-1 p-4 flex flex-col gap-4 overflow-y-auto h-full'>{children}</div>
      </div>
    </>
  )
}
