            ...
            <DialogContent className="max-h-[80vh] overflow-y-auto">
                ...
                <ScrollArea className="h-full pr-4">
                    <div className="space-y-2 p-4">
                        ...
                        <p><Badge>↑/↓</Badge>: Navigate through suggestions</p>
                        <p><Badge>Enter/Space</Badge>: Select highlighted file</p>
                        <p><Badge>→</Badge>: Preview highlighted file</p>
                        <p><Badge>Esc</Badge>: Close suggestions</p>
                        ...
                        <p><Badge>t + [1-9]</Badge>: Switch to project tab</p>
                        <p><Badge>c + [1-9]</Badge>: Switch to chat tab</p>
                        <p><Badge>t + tab</Badge>: Next project tab</p>
                        <p><Badge>t + shift + tab</Badge>: Previous project tab</p>
                        <p><Badge>c + tab</Badge>: Next chat tab</p>
                        <p><Badge>c + shift + tab</Badge>: Previous chat tab</p>
