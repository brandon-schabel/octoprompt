...
export function TokenUsageTooltip({ 
  ...
  const input = 'input_tokens' in tokenUsage 
    ? tokenUsage.input_tokens 
    : tokenUsage.totalInputTokens
  const cacheCreation = 'cache_creation_input_tokens' in tokenUsage
    ? tokenUsage.cache_creation_input_tokens
    : tokenUsage.totalCacheCreationTokens
  const cacheRead = 'cache_read_input_tokens' in tokenUsage
    ? tokenUsage.cache_read_input_tokens
    : tokenUsage.totalCacheReadTokens
  const output = 'output_tokens' in tokenUsage
    ? tokenUsage.output_tokens
    : tokenUsage.totalOutputTokens
  const total = 'totalTokens' in tokenUsage
