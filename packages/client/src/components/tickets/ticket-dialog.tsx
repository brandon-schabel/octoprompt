        ...
        <form onSubmit={handleSubmit} className='space-y-4 mt-4'>
          <div className='flex flex-col gap-2 md:flex-row'>
            ...
            <div className='w-full space-y-2'>
              ...
              <Select value={priority} onValueChange={(val) => setPriority(val as 'low' | 'normal' | 'high')}>
                <SelectTrigger>
            ...
            <div className='w-full space-y-2'>
              ...
              <Select value={status} onValueChange={(val) => setStatus(val as 'open' | 'in_progress' | 'closed')}>
                <SelectTrigger>
          ...
          {ticketWithTasks && <TicketTasksPanel ticketId={String(ticketWithTasks.ticket.id)} overview={overview} />}
