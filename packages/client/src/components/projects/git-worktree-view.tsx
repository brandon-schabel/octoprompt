...
import { useGitWorktrees, useAddGitWorktree, useRemoveGitWorktree, useLockGitWorktree, useUnlockGitWorktree, usePruneGitWorktrees, useGitBranches } from '@/hooks/api/use-git-api'
...
import type { GitWorktree } from '@octoprompt/schemas'
  ...
  return (
    <TooltipProvider>
      <div className={cn('flex flex-col h-full', className)}>
        ...
        <Dialog open={!!lockingWorktree} onOpenChange={() => {
          setLockingWorktree(null)
          setLockReason('')
        }}>
          <DialogContent>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button 
                ...
                disabled={!path.trim() || addWorktree.isPending}
              >
                Add Worktree
              </Button>
            </DialogFooter>
        ...
        <AlertDialog open={pruneDialogOpen} onOpenChange={setPruneDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will remove references to worktrees that no longer exist on disk.
                Would you like to do a dry run first to see what would be pruned?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
