...
import { FolderOpen, Layers, Sparkles, Keyboard, GripVertical, Save, ArrowRight, Info } from 'lucide-react'
...
export function EmptyProjectTabsView({ onOpenProjectInTab, className }: EmptyProjectTabsViewProps) {
  ...
  return (
    <div
      className={cn('flex flex-col items-center justify-center min-h-[600px] p-8 relative overflow-hidden', className)}
    >
      ...
      <div className='relative z-10 max-w-4xl w-full space-y-8'>
        ...
        <div className='text-center space-y-4'>
          ...
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            Project Tabs help you manage multiple contexts within your project. Each tab maintains its own file
            selections, prompts, and user input, allowing you to work on different features without losing your place.
          </p>
        </div>
        ...
        <Card className='border-primary/20 bg-card/50 backdrop-blur-sm shadow-lg'>
          ...
          <CardContent className='flex justify-center pb-6'>
            <Button size='lg' onClick={onOpenProjectInTab} className='gap-2 shadow-sm'>
        ...
        <div className='flex justify-center'>
          <PromptlianoTooltip>{keyboardShortcuts}</PromptlianoTooltip>
