...
export const getApiAgentCoderLogsQueryKey = (options?: Options<GetApiAgentCoderLogsData>) => createQueryKey('getApiAgentCoderLogs', options);

export const getApiAgentCoderLogsOptions = (options?: Options<GetApiAgentCoderLogsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiAgentCoderLogs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiAgentCoderLogsQueryKey(options)
    });
};

export const getApiAgentCoderLogsListQueryKey = (options?: Options<GetApiAgentCoderLogsListData>) => createQueryKey('getApiAgentCoderLogsList', options);

export const getApiAgentCoderLogsListOptions = (options?: Options<GetApiAgentCoderLogsListData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiAgentCoderLogsList({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiAgentCoderLogsListQueryKey(options)
    });
};