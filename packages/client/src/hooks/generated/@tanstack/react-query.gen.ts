...
export const getApiStateQueryKey = (options?: Options<GetApiStateData>) => createQueryKey('getApiState', options);

export const getApiStateOptions = (options?: Options<GetApiStateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiState({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiStateQueryKey(options)
    });
};

export const putApiStateMutation = (options?: Partial<Options<PutApiStateData>>): UseMutationOptions<PutApiStateResponse, PutApiStateError, Options<PutApiStateData>> => {
    const mutationOptions: UseMutationOptions<PutApiStateResponse, PutApiStateError, Options<PutApiStateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await putApiState({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const postApiStateSettingsQueryKey = (options: Options<PostApiStateSettingsData>) => createQueryKey('postApiStateSettings', options);

export const postApiStateSettingsOptions = (options: Options<PostApiStateSettingsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateSettings({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateSettingsQueryKey(options)
    });
};

export const postApiStateSettingsMutation = (options?: Partial<Options<PostApiStateSettingsData>>): UseMutationOptions<PostApiStateSettingsResponse, PostApiStateSettingsError, Options<PostApiStateSettingsData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateSettingsResponse, PostApiStateSettingsError, Options<PostApiStateSettingsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateSettings({
                ...options,
                ...localOptions,
...
export const postApiStateActiveProjectTabQueryKey = (options: Options<PostApiStateActiveProjectTabData>) => createQueryKey('postApiStateActiveProjectTab', options);

export const postApiStateActiveProjectTabOptions = (options: Options<PostApiStateActiveProjectTabData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateActiveProjectTab({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateActiveProjectTabQueryKey(options)
    });
};

export const postApiStateActiveProjectTabMutation = (options?: Partial<Options<PostApiStateActiveProjectTabData>>): UseMutationOptions<PostApiStateActiveProjectTabResponse, PostApiStateActiveProjectTabError, Options<PostApiStateActiveProjectTabData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateActiveProjectTabResponse, PostApiStateActiveProjectTabError, Options<PostApiStateActiveProjectTabData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateActiveProjectTab({
                ...options,
                ...localOptions,
...
export const postApiStateActiveChatQueryKey = (options: Options<PostApiStateActiveChatData>) => createQueryKey('postApiStateActiveChat', options);

export const postApiStateActiveChatOptions = (options: Options<PostApiStateActiveChatData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateActiveChat({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateActiveChatQueryKey(options)
    });
};

export const postApiStateActiveChatMutation = (options?: Partial<Options<PostApiStateActiveChatData>>): UseMutationOptions<PostApiStateActiveChatResponse, PostApiStateActiveChatError, Options<PostApiStateActiveChatData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateActiveChatResponse, PostApiStateActiveChatError, Options<PostApiStateActiveChatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateActiveChat({
                ...options,
                ...localOptions,
...
export const postApiStateProjectTabsQueryKey = (options: Options<PostApiStateProjectTabsData>) => createQueryKey('postApiStateProjectTabs', options);

export const postApiStateProjectTabsOptions = (options: Options<PostApiStateProjectTabsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateProjectTabs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateProjectTabsQueryKey(options)
    });
};

export const postApiStateProjectTabsMutation = (options?: Partial<Options<PostApiStateProjectTabsData>>): UseMutationOptions<PostApiStateProjectTabsResponse, PostApiStateProjectTabsError, Options<PostApiStateProjectTabsData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateProjectTabsResponse, PostApiStateProjectTabsError, Options<PostApiStateProjectTabsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateProjectTabs({
                ...options,
                ...localOptions,
...
export const deleteApiStateProjectTabsByTabIdMutation = (options?: Partial<Options<DeleteApiStateProjectTabsByTabIdData>>): UseMutationOptions<DeleteApiStateProjectTabsByTabIdResponse, DeleteApiStateProjectTabsByTabIdError, Options<DeleteApiStateProjectTabsByTabIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiStateProjectTabsByTabIdResponse, DeleteApiStateProjectTabsByTabIdError, Options<DeleteApiStateProjectTabsByTabIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteApiStateProjectTabsByTabId({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const postApiStateProjectTabsByTabIdQueryKey = (options: Options<PostApiStateProjectTabsByTabIdData>) => createQueryKey('postApiStateProjectTabsByTabId', options);

export const postApiStateProjectTabsByTabIdOptions = (options: Options<PostApiStateProjectTabsByTabIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateProjectTabsByTabId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateProjectTabsByTabIdQueryKey(options)
    });
};

export const postApiStateProjectTabsByTabIdMutation = (options?: Partial<Options<PostApiStateProjectTabsByTabIdData>>): UseMutationOptions<PostApiStateProjectTabsByTabIdResponse, PostApiStateProjectTabsByTabIdError, Options<PostApiStateProjectTabsByTabIdData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateProjectTabsByTabIdResponse, PostApiStateProjectTabsByTabIdError, Options<PostApiStateProjectTabsByTabIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateProjectTabsByTabId({
                ...options,
                ...localOptions,
...
export const postApiStateProjectTabsReplaceAllQueryKey = (options: Options<PostApiStateProjectTabsReplaceAllData>) => createQueryKey('postApiStateProjectTabsReplaceAll', options);

export const postApiStateProjectTabsReplaceAllOptions = (options: Options<PostApiStateProjectTabsReplaceAllData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateProjectTabsReplaceAll({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateProjectTabsReplaceAllQueryKey(options)
    });
};

export const postApiStateProjectTabsReplaceAllMutation = (options?: Partial<Options<PostApiStateProjectTabsReplaceAllData>>): UseMutationOptions<PostApiStateProjectTabsReplaceAllResponse, PostApiStateProjectTabsReplaceAllError, Options<PostApiStateProjectTabsReplaceAllData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateProjectTabsReplaceAllResponse, PostApiStateProjectTabsReplaceAllError, Options<PostApiStateProjectTabsReplaceAllData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateProjectTabsReplaceAll({
                ...options,
                ...localOptions,
...
export const postApiStateUpdateQueryKey = (options: Options<PostApiStateUpdateData>) => createQueryKey('postApiStateUpdate', options);

export const postApiStateUpdateOptions = (options: Options<PostApiStateUpdateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiStateUpdate({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiStateUpdateQueryKey(options)
    });
};

export const postApiStateUpdateMutation = (options?: Partial<Options<PostApiStateUpdateData>>): UseMutationOptions<PostApiStateUpdateResponse, PostApiStateUpdateError, Options<PostApiStateUpdateData>> => {
    const mutationOptions: UseMutationOptions<PostApiStateUpdateResponse, PostApiStateUpdateError, Options<PostApiStateUpdateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiStateUpdate({
                ...options,
                ...localOptions,
