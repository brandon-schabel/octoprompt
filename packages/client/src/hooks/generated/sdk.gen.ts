 ...
 */
export const postAiGenerateText = <ThrowOnError extends boolean = false>(options: Options<PostAiGenerateTextData, ThrowOnError>) => {
 ...
 */
export const getApiAgentCoderRuns = <ThrowOnError extends boolean = false>(options?: Options<GetApiAgentCoderRunsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiAgentCoderRunsResponse, GetApiAgentCoderRunsError, ThrowOnError>({
 ...
 */
export const getApiAgentCoderRunsByAgentJobIdLogs = <ThrowOnError extends boolean = false>(options: Options<GetApiAgentCoderRunsByAgentJobIdLogsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAgentCoderRunsByAgentJobIdLogsResponse, GetApiAgentCoderRunsByAgentJobIdLogsError, ThrowOnError>({
 ...
 */
export const getApiAgentCoderRunsByAgentJobIdData = <ThrowOnError extends boolean = false>(options: Options<GetApiAgentCoderRunsByAgentJobIdDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAgentCoderRunsByAgentJobIdDataResponse, GetApiAgentCoderRunsByAgentJobIdDataError, ThrowOnError>({
 ...
 */
export const postApiAgentCoderRunsByAgentJobIdConfirm = <ThrowOnError extends boolean = false>(options: Options<PostApiAgentCoderRunsByAgentJobIdConfirmData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiAgentCoderRunsByAgentJobIdConfirmResponse, PostApiAgentCoderRunsByAgentJobIdConfirmError, ThrowOnError>({
...
/**
 * Set a value in the KV store for a given key
 */
export const postApiKv = <ThrowOnError extends boolean = false>(options?: Options<PostApiKvData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostApiKvResponse, PostApiKvError, ThrowOnError>({
        url: '/api/kv',
        ...options,
        headers: {
            'Content-Type': 'application/json',
