...
/**
 * Retrieve the execution logs for a specific Agent Coder run or the latest run via logId query parameter
 */
export const getApiAgentCoderLogs = <ThrowOnError extends boolean = false>(options?: Options<GetApiAgentCoderLogsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiAgentCoderLogsResponse, GetApiAgentCoderLogsError, ThrowOnError>({
...
/**
 * List available Agent Coder log filenames
 */
export const getApiAgentCoderLogsList = <ThrowOnError extends boolean = false>(options?: Options<GetApiAgentCoderLogsListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiAgentCoderLogsListResponse, GetApiAgentCoderLogsListError, ThrowOnError>({
