...
export const postAiGenerateTextQueryKey = (options: Options<PostAiGenerateTextData>) => createQueryKey('postAiGenerateText', options);
...
export const postAiGenerateTextMutation = (options?: Partial<Options<PostAiGenerateTextData>>): UseMutationOptions<PostAiGenerateTextResponse, PostAiGenerateTextError, Options<PostAiGenerateTextData>> => {
    const mutationOptions: UseMutationOptions<PostAiGenerateTextResponse, PostAiGenerateTextError, Options<PostAiGenerateTextData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postAiGenerateText({
                ...options,
                ...localOptions,
...
export const getApiAgentCoderRunsQueryKey = (options?: Options<GetApiAgentCoderRunsData>) => createQueryKey('getApiAgentCoderRuns', options);

export const getApiAgentCoderRunsOptions = (options?: Options<GetApiAgentCoderRunsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiAgentCoderRuns({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiAgentCoderRunsQueryKey(options)
    });
};

export const getApiAgentCoderRunsByAgentJobIdLogsQueryKey = (options: Options<GetApiAgentCoderRunsByAgentJobIdLogsData>) => createQueryKey('getApiAgentCoderRunsByAgentJobIdLogs', options);

export const getApiAgentCoderRunsByAgentJobIdLogsOptions = (options: Options<GetApiAgentCoderRunsByAgentJobIdLogsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiAgentCoderRunsByAgentJobIdLogs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiAgentCoderRunsByAgentJobIdLogsQueryKey(options)
    });
};

export const getApiAgentCoderRunsByAgentJobIdDataQueryKey = (options: Options<GetApiAgentCoderRunsByAgentJobIdDataData>) => createQueryKey('getApiAgentCoderRunsByAgentJobIdData', options);

export const getApiAgentCoderRunsByAgentJobIdDataOptions = (options: Options<GetApiAgentCoderRunsByAgentJobIdDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiAgentCoderRunsByAgentJobIdData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiAgentCoderRunsByAgentJobIdDataQueryKey(options)
    });
};

export const postApiAgentCoderRunsByAgentJobIdConfirmQueryKey = (options: Options<PostApiAgentCoderRunsByAgentJobIdConfirmData>) => createQueryKey('postApiAgentCoderRunsByAgentJobIdConfirm', options);

export const postApiAgentCoderRunsByAgentJobIdConfirmOptions = (options: Options<PostApiAgentCoderRunsByAgentJobIdConfirmData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiAgentCoderRunsByAgentJobIdConfirm({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiAgentCoderRunsByAgentJobIdConfirmQueryKey(options)
    });
};

export const postApiAgentCoderRunsByAgentJobIdConfirmMutation = (options?: Partial<Options<PostApiAgentCoderRunsByAgentJobIdConfirmData>>): UseMutationOptions<PostApiAgentCoderRunsByAgentJobIdConfirmResponse, PostApiAgentCoderRunsByAgentJobIdConfirmError, Options<PostApiAgentCoderRunsByAgentJobIdConfirmData>> => {
    const mutationOptions: UseMutationOptions<PostApiAgentCoderRunsByAgentJobIdConfirmResponse, PostApiAgentCoderRunsByAgentJobIdConfirmError, Options<PostApiAgentCoderRunsByAgentJobIdConfirmData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiAgentCoderRunsByAgentJobIdConfirm({
                ...options,
                ...localOptions,
...
export const deleteApiKvMutation = (options?: Partial<Options<DeleteApiKvData>>): UseMutationOptions<DeleteApiKvResponse, DeleteApiKvError, Options<DeleteApiKvData>> => {
...
export const postApiKvQueryKey = (options?: Options<PostApiKvData>) => createQueryKey('postApiKv', options);

export const postApiKvOptions = (options?: Options<PostApiKvData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postApiKv({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postApiKvQueryKey(options)
    });
};

export const postApiKvMutation = (options?: Partial<Options<PostApiKvData>>): UseMutationOptions<PostApiKvResponse, PostApiKvError, Options<PostApiKvData>> => {
    const mutationOptions: UseMutationOptions<PostApiKvResponse, PostApiKvError, Options<PostApiKvData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postApiKv({
                ...options,
                ...localOptions,
