...
import type { GetApiChatsData, GetApiChatsResponse, GetApiChatsError, PostApiChatsData, PostApiChatsResponse, PostApiChatsError, GetApiChatsByChatIdMessagesData, GetApiChatsByChatIdMessagesResponse, GetApiChatsByChatIdMessagesError, PostApiAiChatData, PostApiAiChatResponse, PostApiAiChatError, PostApiChatsByChatIdForkData, PostApiChatsByChatIdForkResponse, PostApiChatsByChatIdForkError, PostApiChatsByChatIdForkByMessageIdData, PostApiChatsByChatIdForkByMessageIdResponse, PostApiChatsByChatIdForkByMessageIdError, DeleteApiChatsByChatIdMessagesByMessageIdData, DeleteApiChatsByChatIdMessagesByMessageIdResponse, DeleteApiChatsByChatIdMessagesByMessageIdError, DeleteApiChatsByChatIdData, DeleteApiChatsByChatIdResponse, DeleteApiChatsByChatIdError, PatchApiChatsByChatIdData, PatchApiChatsByChatIdResponse, PatchApiChatsByChatIdError, PostApiTicketsData, PostApiTicketsResponse, PostApiTicketsError, DeleteApiTicketsByTicketIdData, DeleteApiTicketsByTicketIdResponse, DeleteApiTicketsByTicketIdError, GetApiTicketsByTicketIdData, GetApiTicketsByTicketIdResponse, GetApiTicketsByTicketIdError, PatchApiTicketsByTicketIdData, PatchApiTicketsByTicketIdResponse, PatchApiTicketsByTicketIdError, PostApiTicketsByTicketIdLinkFilesData, PostApiTicketsByTicketIdLinkFilesResponse, PostApiTicketsByTicketIdLinkFilesError, PostApiTicketsByTicketIdSuggestFilesData, PostApiTicketsByTicketIdSuggestFilesResponse, PostApiTicketsByTicketIdSuggestFilesError, PostApiTicketsByTicketIdSuggestTasksData, PostApiTicketsByTicketIdSuggestTasksResponse, PostApiTicketsByTicketIdSuggestTasksError, GetApiProjectsByProjectIdTicketsData, GetApiProjectsByProjectIdTicketsResponse, GetApiProjectsByProjectIdTicketsError, GetApiProjectsByProjectIdTicketsWithCountData, GetApiProjectsByProjectIdTicketsWithCountResponse, GetApiProjectsByProjectIdTicketsWithCountError, GetApiProjectsByProjectIdTicketsWithTasksData, GetApiProjectsByProjectIdTicketsWithTasksResponse, GetApiProjectsByProjectIdTicketsWithTasksError, GetApiTicketsByTicketIdTasksData, GetApiTicketsByTicketIdTasksResponse, GetApiTicketsByTicketIdTasksError, PostApiTicketsByTicketIdTasksData, PostApiTicketsByTicketIdTasksResponse, PostApiTicketsByTicketIdTasksError, DeleteApiTicketsByTicketIdTasksByTaskIdData, DeleteApiTicketsByTicketIdTasksByTaskIdResponse, DeleteApiTicketsByTicketIdTasksByTaskIdError, PatchApiTicketsByTicketIdTasksByTaskIdData, PatchApiTicketsByTicketIdTasksByTaskIdResponse, PatchApiTicketsByTicketIdTasksByTaskIdError, PatchApiTicketsByTicketIdTasksReorderData, PatchApiTicketsByTicketIdTasksReorderResponse, PatchApiTicketsByTicketIdTasksReorderError, PostApiTicketsByTicketIdAutoGenerateTasksData, PostApiTicketsByTicketIdAutoGenerateTasksResponse, PostApiTicketsByTicketIdAutoGenerateTasksError, GetApiTicketsBulkTasksData, GetApiTicketsBulkTasksResponse, GetApiTicketsBulkTasksError, GetApiProjectsData, GetApiProjectsResponse, GetApiProjectsError, PostApiProjectsData, PostApiProjectsResponse, PostApiProjectsError, DeleteApiProjectsByProjectIdData, DeleteApiProjectsByProjectIdResponse, DeleteApiProjectsByProjectIdError, GetApiProjectsByProjectIdData, GetApiProjectsByProjectIdResponse, GetApiProjectsByProjectIdError, PatchApiProjectsByProjectIdData, PatchApiProjectsByProjectIdResponse, PatchApiProjectsByProjectIdError, PostApiProjectsByProjectIdSyncData, PostApiProjectsByProjectIdSyncResponse, PostApiProjectsByProjectIdSyncError, GetApiProjectsByProjectIdFilesData, GetApiProjectsByProjectIdFilesResponse, GetApiProjectsByProjectIdFilesError, PostApiProjectsByProjectIdRefreshData, PostApiProjectsByProjectIdRefreshResponse, PostApiProjectsByProjectIdRefreshError, GetApiProjectsByProjectIdSummaryData, GetApiProjectsByProjectIdSummaryResponse, GetApiProjectsByProjectIdSummaryError, PostApiProjectsByProjectIdSuggestFilesData, PostApiProjectsByProjectIdSuggestFilesResponse, PostApiProjectsByProjectIdSuggestFilesError, PostApiProjectsByProjectIdSummarizeData, PostApiProjectsByProjectIdSummarizeResponse, PostApiProjectsByProjectIdSummarizeError, PostApiProjectsByProjectIdRemoveSummariesData, PostApiProjectsByProjectIdRemoveSummariesResponse, PostApiProjectsByProjectIdRemoveSummariesError, PostApiPromptOptimizeData, PostApiPromptOptimizeResponse, PostApiPromptOptimizeError, GetApiKeysData, GetApiKeysResponse, GetApiKeysError, PostApiKeysData, PostApiKeysResponse, PostApiKeysError, DeleteApiKeysByKeyIdData, DeleteApiKeysByKeyIdResponse, DeleteApiKeysByKeyIdError, GetApiKeysByKeyIdData, GetApiKeysByKeyIdResponse, GetApiKeysByKeyIdError, PatchApiKeysByKeyIdData, PatchApiKeysByKeyIdResponse, PatchApiKeysByKeyIdError, GetApiAdminEnvInfoData, GetApiAdminEnvInfoResponse, GetApiAdminEnvInfoError, GetApiAdminSystemStatusData, GetApiAdminSystemStatusResponse, GetApiAdminSystemStatusError, PostApiProjectsByProjectIdAiFileChangesData, PostApiProjectsByProjectIdAiFileChangesResponse, PostApiProjectsByProjectIdAiFileChangesError, GetApiProjectsByProjectIdAiFileChangesByAiFileChangeIdData, GetApiProjectsByProjectIdAiFileChangesByAiFileChangeIdResponse, GetApiProjectsByProjectIdAiFileChangesByAiFileChangeIdError, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirmData, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirmResponse, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirmError, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdRejectData, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdRejectResponse, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdRejectError, GetApiPromptsData, GetApiPromptsResponse, GetApiPromptsError, PostApiPromptsData, PostApiPromptsResponse, PostApiPromptsError, GetApiProjectsByProjectIdPromptsData, GetApiProjectsByProjectIdPromptsResponse, GetApiProjectsByProjectIdPromptsError, DeleteApiProjectsByProjectIdPromptsByPromptIdData, DeleteApiProjectsByProjectIdPromptsByPromptIdResponse, DeleteApiProjectsByProjectIdPromptsByPromptIdError, PostApiProjectsByProjectIdPromptsByPromptIdData, PostApiProjectsByProjectIdPromptsByPromptIdResponse, PostApiProjectsByProjectIdPromptsByPromptIdError, DeleteApiPromptsByPromptIdData, DeleteApiPromptsByPromptIdResponse, DeleteApiPromptsByPromptIdError, GetApiPromptsByPromptIdData, GetApiPromptsByPromptIdResponse, GetApiPromptsByPromptIdError, PatchApiPromptsByPromptIdData, PatchApiPromptsByPromptIdResponse, PatchApiPromptsByPromptIdError, PostApiGenAiStreamData, PostApiGenAiStreamResponse, PostApiGenAiTextData, PostApiGenAiTextResponse, PostApiGenAiTextError, PostApiGenAiStructuredData, PostApiGenAiStructuredResponse, PostApiGenAiStructuredError, GetApiModelsData, GetApiModelsResponse, GetApiModelsError, PostApiAiGenerateTextData, PostApiAiGenerateTextResponse, PostApiAiGenerateTextError, PostApiProjectsByProjectIdAgentCoderData, PostApiProjectsByProjectIdAgentCoderResponse, PostApiProjectsByProjectIdAgentCoderError, GetApiAgentCoderProjectByProjectIdRunsData, GetApiAgentCoderProjectByProjectIdRunsResponse, GetApiAgentCoderProjectByProjectIdRunsError, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogsData, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogsResponse, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogsError, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdDataData, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdDataResponse, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdDataError, PostApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirmData, PostApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirmResponse, PostApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirmError, DeleteApiAgentCoderRunsByAgentJobIdData, DeleteApiAgentCoderRunsByAgentJobIdResponse, DeleteApiAgentCoderRunsByAgentJobIdError } from './types.gen';
 ...
 */
export const postApiChats = <ThrowOnError extends boolean = false>(options: Options<PostApiChatsData, ThrowOnError>) => {
 ...
 */
export const getApiChatsByChatIdMessages = <ThrowOnError extends boolean = false>(options: Options<GetApiChatsByChatIdMessagesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiChatsByChatIdMessagesResponse, GetApiChatsByChatIdMessagesError, ThrowOnError>({
 ...
 */
export const postApiAiChat = <ThrowOnError extends boolean = false>(options: Options<PostApiAiChatData, ThrowOnError>) => {
 ...
 * Fork a chat session
 */
export const postApiChatsByChatIdFork = <ThrowOnError extends boolean = false>(options: Options<PostApiChatsByChatIdForkData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiChatsByChatIdForkResponse, PostApiChatsByChatIdForkError, ThrowOnError>({
 ...
 */
export const postApiChatsByChatIdForkByMessageId = <ThrowOnError extends boolean = false>(options: Options<PostApiChatsByChatIdForkByMessageIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiChatsByChatIdForkByMessageIdResponse, PostApiChatsByChatIdForkByMessageIdError, ThrowOnError>({
 ...
 */
export const deleteApiChatsByChatIdMessagesByMessageId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiChatsByChatIdMessagesByMessageIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiChatsByChatIdMessagesByMessageIdResponse, DeleteApiChatsByChatIdMessagesByMessageIdError, ThrowOnError>({
 ...
 */
export const deleteApiChatsByChatId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiChatsByChatIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiChatsByChatIdResponse, DeleteApiChatsByChatIdError, ThrowOnError>({
 ...
 */
export const patchApiChatsByChatId = <ThrowOnError extends boolean = false>(options: Options<PatchApiChatsByChatIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchApiChatsByChatIdResponse, PatchApiChatsByChatIdError, ThrowOnError>({
        url: '/api/chats/{chatId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const postApiProjectsByProjectIdAiFileChanges = <ThrowOnError extends boolean = false>(options: Options<PostApiProjectsByProjectIdAiFileChangesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiProjectsByProjectIdAiFileChangesResponse, PostApiProjectsByProjectIdAiFileChangesError, ThrowOnError>({
 ...
 */
export const getApiProjectsByProjectIdAiFileChangesByAiFileChangeId = <ThrowOnError extends boolean = false>(options: Options<GetApiProjectsByProjectIdAiFileChangesByAiFileChangeIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiProjectsByProjectIdAiFileChangesByAiFileChangeIdResponse, GetApiProjectsByProjectIdAiFileChangesByAiFileChangeIdError, ThrowOnError>({
 ...
 */
export const postApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirm = <ThrowOnError extends boolean = false>(options: Options<PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirmData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirmResponse, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdConfirmError, ThrowOnError>({
 ...
 */
export const postApiProjectsByProjectIdAiFileChangesByAiFileChangeIdReject = <ThrowOnError extends boolean = false>(options: Options<PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdRejectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdRejectResponse, PostApiProjectsByProjectIdAiFileChangesByAiFileChangeIdRejectError, ThrowOnError>({
 ...
 */
export const postApiGenAiStream = <ThrowOnError extends boolean = false>(options: Options<PostApiGenAiStreamData, ThrowOnError>) => {
 ...
 * Generate text using a specified model and prompt
 */
export const postApiGenAiText = <ThrowOnError extends boolean = false>(options: Options<PostApiGenAiTextData, ThrowOnError>) => {
 ...
 */
export const postApiGenAiStructured = <ThrowOnError extends boolean = false>(options: Options<PostApiGenAiStructuredData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiGenAiStructuredResponse, PostApiGenAiStructuredError, ThrowOnError>({
 ...
 */
export const postApiAiGenerateText = <ThrowOnError extends boolean = false>(options: Options<PostApiAiGenerateTextData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiAiGenerateTextResponse, PostApiAiGenerateTextError, ThrowOnError>({
 ...
 */
export const postApiProjectsByProjectIdAgentCoder = <ThrowOnError extends boolean = false>(options: Options<PostApiProjectsByProjectIdAgentCoderData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiProjectsByProjectIdAgentCoderResponse, PostApiProjectsByProjectIdAgentCoderError, ThrowOnError>({
 ...
 */
export const getApiAgentCoderProjectByProjectIdRuns = <ThrowOnError extends boolean = false>(options: Options<GetApiAgentCoderProjectByProjectIdRunsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAgentCoderProjectByProjectIdRunsResponse, GetApiAgentCoderProjectByProjectIdRunsError, ThrowOnError>({
 ...
 */
export const getApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogs = <ThrowOnError extends boolean = false>(options: Options<GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogsResponse, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdLogsError, ThrowOnError>({
 ...
 */
export const getApiAgentCoderProjectByProjectIdRunsByAgentJobIdData = <ThrowOnError extends boolean = false>(options: Options<GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdDataResponse, GetApiAgentCoderProjectByProjectIdRunsByAgentJobIdDataError, ThrowOnError>({
 ...
 */
export const postApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirm = <ThrowOnError extends boolean = false>(options: Options<PostApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirmData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirmResponse, PostApiAgentCoderProjectByProjectIdRunsByAgentJobIdConfirmError, ThrowOnError>({
 ...
 */
export const deleteApiAgentCoderRunsByAgentJobId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiAgentCoderRunsByAgentJobIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiAgentCoderRunsByAgentJobIdResponse, DeleteApiAgentCoderRunsByAgentJobIdError, ThrowOnError>({
