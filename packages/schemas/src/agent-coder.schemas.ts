...
import { ProjectFileSchema, ProjectFileMapSchema, ProjectSchema } from './project.schemas'
...
// API type aliases for consistency
export type RunAgentCoderBody = AgentCoderRunRequest
export type RunAgentCoderResponseData = AgentCoderRunResponse
export type ListAgentCoderRunsResponseData = z.infer<typeof ListAgentCoderRunsResponseSchema>
export type GetAgentCoderLogsResponseData = z.infer<typeof GetAgentCoderLogsResponseSchema>
export type GetAgentCoderDataResponseData = z.infer<typeof GetAgentCoderDataResponseSchema>
export type ConfirmAgentCoderChangesResponseData = z.infer<typeof ConfirmAgentCoderChangesResponseSchema>
export type DeleteAgentCoderRunResponseData = z.infer<typeof DeleteAgentCoderRunResponseSchema>
export type AgentCoderRun = AgentCoderRunSuccessData
export type AgentCoderLog = Record<string, unknown>
