...
/**
 * Database adapter for StorageV2 that uses the centralized DatabaseManager
 * This adapter integrates with the SQLite-based DatabaseManager for unified storage
 */
export class DatabaseAdapter<T> implements StorageAdapter<T> {
